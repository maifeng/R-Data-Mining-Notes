...
Here we demonstrate Lasso on Boston Housing data. If you have a binary response you can use _family= "binomial"_ option in the glmnet() function. 
...
[3]: http://www.stanford.edu/~hastie/TALKS/enet_talk.pdf "Regularization and Variable
